...
Route::middleware('auth')->group(function () {
    ...
    // Ruta para buscar reparación por código (accesible desde formulario)
    ...
    // Configuración de Facturas (POST para evitar problemas con PUT en proxys/servidores)
    ...
    // Usuarios del Sistema (solo administradores - verificación en controlador)
    Route::resource('usuarios', UsuariosController::class);
    
    // Facturas ({factura} solo numérico para no capturar /facturas/configuracion)
    ...
    // Editar facturas (solo admin) - La verificación de admin se hace en el controlador
...
// Rutas públicas (sin autenticación) - Consulta de estado para clientes
// Soporta subdirectorio (ej: localhost/martinez/public/consulta)
